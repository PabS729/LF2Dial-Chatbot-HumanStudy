...
STRAT_FOR_STATES_R_D = {
    "1": "Treating the student's response as counterargument to your stance, point out the logical flaw with the example/assumption, and tell the student the right way to demonstrate logical validity of <sentence> e.g. 'logical validity ...', finally request the student to provide evidence that supports his claim. e.g. Can you provide examples...",
    "2": """
    First, Show all necessary conditions for the argument to hold logically valid. Then, refute the student's argument using one of the following strategy. If possible, also include counterargument/counterexamples in your response.
    a. Showing that the argument's conclusion or premise is wrong. Provide a counterargument or counterexample to illustrate your point.
    b. Showing that the argument's conclusion does not follow from the premise. Provide a counterargument or counterexample to illustrate your point.
    c. Showing that the argument is irrelevant to the topic of discussion. Even if the evidence provided is valid, it may be irrelevant to the logical validity of <sentence>, and thus can be dismissed.
    """,
    
    "3": "First, tell the student the right way to demonstrate logical validity of <sentence>. Then, respond to the student's request on providing evidence or clarifications, and give support to your stance. ",
    "4": """"Treating the student's response as counterargument to your stance, point out the logical flaw with the example/assumption, and tell the student the right way to demonstrate logical validity of <sentence> 'logical validity ...', finally request the student about their assumptions in their arguments. e.g. 'Why do you assume...' or 'How do you know...'. 
    """,
