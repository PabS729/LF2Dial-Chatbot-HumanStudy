...
def generate_res(role, model_name, sentence, history, profile, target_statement, 
    ...
    elif role in ["fact_bank", "gen_strategy", "student", "conv", "tea"]:
    ...
    if role in ["teacher_st", "teacher", "t_edu", "exp", "old", "tea"]: 
